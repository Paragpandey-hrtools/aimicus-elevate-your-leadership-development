...
const SixthOutputScreen = ({ selectedTheme, selectedMethodologies, onNextClick, onBack, APPS_SCRIPT_URL }) => {
    ...
    <div className="flex flex-col items-center min-h-screen bg-white p-4">
      ...
      <div className="w-full max-w-4xl flex gap-6 mb-8">
        ...
        <div className="flex-1">
          <TruncatableText
            text={selectedTheme?.newMethodology2Idea || 'Loading methodology details...'}
            type="text1"
            align="left"
          />
        </div>
      ...
      <div className="w-full max-w-4xl flex gap-6 mb-8">
        ...
        <div className="flex-1">
          <TruncatableText
            text={selectedTheme?.newMethodology2Trainers || 'Loading trainers details...'}
            type="text2"
            align="right"
          />
        </div>
...
export default SixthOutputScreen;

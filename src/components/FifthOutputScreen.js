...
const FifthOutputScreen = ({ selectedTheme, selectedMethodologies, onNextClick, onBack, APPS_SCRIPT_URL }) => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-white p-4">
      ...
      {/* First Selection - New Methodology Idea */}
      <div className="w-full max-w-4xl flex gap-6 mb-8">
        <div className="w-44 h-44 flex-shrink-0">
          <img
            src={selectedMethodologies?.ideaImageUrl || '/api/placeholder/200/200'}
            alt="New Methodology Idea"
            className="w-full h-full object-contain"
          />
        </div>
        <div className="flex-1">
          <TruncatableText
            text={selectedTheme?.newMethodology1Idea || 'Loading methodology details...'}
            type="text1"
            align="left"
          />
        </div>
      ...
      <div className="w-full max-w-4xl flex gap-6 mb-8">
        <div className="w-44 h-44 flex-shrink-0">
          <img
            ...
            alt="Trainers Using New Methodology"
            className="w-full h-full object-contain"
          />
        </div>
        <div className="flex-1">
          <TruncatableText
            text={selectedTheme?.newMethodology1Trainers || 'Loading trainers details...'}
            type="text2"
            align="right"
          />
        </div>
...
export default FifthOutputScreen;
